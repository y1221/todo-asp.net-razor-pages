...
namespace TodoRazorApp.Migrations
{
    ...
    [Migration("20240817020501_AddCategory")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TodoRazorApp.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TodoRazorApp.Models.Todo", b =>
                {
                    b.HasOne("TodoRazorApp.Models.Account", "Account")
                        .WithMany("Todos")
                        .HasForeignKey("AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TodoRazorApp.Models.Category", "Category")
                        .WithMany("Todos")
